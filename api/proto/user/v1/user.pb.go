...
const file_api_proto_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\x89\x01\n" +
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x15.user.v1.UserResponse\x129\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x15.user.v1.UserResponseBIZGgithub.com/nithibodee/7-solutions-backend-test/api/proto/user/v1;userv1b\x06proto3"
...
var file_api_proto_user_v1_user_proto_depIdxs = []int32{
	3, // 0: user.v1.UserResponse.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: user.v1.UserResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	2, // 4: user.v1.UserService.CreateUser:output_type -> user.v1.UserResponse
	2, // 5: user.v1.UserService.GetUser:output_type -> user.v1.UserResponse
